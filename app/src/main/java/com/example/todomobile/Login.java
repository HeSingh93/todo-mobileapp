...
public class Login extends ToDoActivity {
    ...
    private void getData() {
        ...
        WorkOrder workOrder4 = new WorkOrder(4, "2020-09-21 08:30", "Hamnvägen 8, Skellefteå", "Service av fläkt i fabrikslokal", "Erik Engdahl 070-474747", customer1, employee3, STATUS_ACCEPTED);
        ...
        WorkOrder workOrder6 = new WorkOrder(6, "2021-01-07 13:00", "Mogatan 44, Anderstorp", "Årlig service av 4 entredörrar", "Stig Axelsson 070-4598777", customer1, employee3, STATUS_ACCEPTED);
